      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-4 lg:px-8">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/area-layanan" className="hover:text-primary">Area Layanan</Link></li>
            <li><Link to="/testimoni" className="hover:text-primary">Testimoni</Link></li>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
            ...
            <li className="flex items-start gap-2.5">
              ...
              <a href={waLink("Halo, saya ingin konsultasi.")} target="_blank" rel="noopener noreferrer" className="hover:text-primary">
                {SITE.phone}
              </a>
            </li>
            <li className="flex items-start gap-2.5">
