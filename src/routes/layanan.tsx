...
function Page() {
  ...
  useEffect(() => {
    setServices(getPersistedServices());
  }, []);
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <Reveal>
          ...
          <h1 className="max-w-4xl font-display text-4xl font-extrabold leading-tight sm:text-5xl md:text-6xl">
            Semua kebutuhan{" "}
            <span className="text-gradient-industrial">las dan konstruksi besi</span> Anda
          </h1>
          <p className="mt-4 max-w-2xl text-base text-muted-foreground">
            Dari pagar rumah, kanopi carport, sampai konstruksi gudang — tim Bara Baja Las siap
            mengerjakan dengan standar profesional.
          </p>
        </Reveal>
