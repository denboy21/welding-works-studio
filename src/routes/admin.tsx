...
function AdminDashboard({ onLogout }: { onLogout: () => void }) {
  ...
  function handleTestimonialSubmit(e: React.FormEvent) {
    e.preventDefault();
    if (editTestimonial)
      updateTestimonialMutation.mutate({ ...testimonialForm, id: editTestimonial.id });
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setPortfolioForm({ ...portfolioForm, image_url: e.target.value })
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setPortfolioForm({ ...portfolioForm, sort_order: Number(e.target.value) })
                      }
                      className="w-full bg-slate-700 text-white px-3 py-2 rounded-lg text-sm outline-none focus:ring-2 focus:ring-orange-500"
                    />
                  </div>
                  <div className="flex items-center gap-3 pt-4">
                    <label className="flex items-center gap-2 text-sm text-slate-300 cursor-pointer">
                      <input
                        type="checkbox"
                        checked={portfolioForm.is_featured === 1}
                        onChange={(e) =>
                          setPortfolioForm({
                            ...portfolioForm,
                        ...
                        <td className="px-4 py-3">
                          <div className="flex gap-2">
                            ...
                            {deletePortfolioConfirm === item.id ? (
                              ...
                              <button
                                type="button"
                                onClick={() => setDeletePortfolioConfirm(item.id)}
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setTestimonialForm({ ...testimonialForm, avatar_url: e.target.value })
                      }
                      ...
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <div className="flex gap-2 flex-shrink-0">
                          ...
                          {deleteTestimonialConfirm === item.id ? (
                            ...
                            <button
                              type="button"
                              onClick={() => setDeleteTestimonialConfirm(item.id)}
                              className="text-xs bg-slate-700 hover:bg-red-600 text-slate-400 hover:text-white px-3 py-1 rounded transition"
                            >
                              Hapus
                            </button>
                ...
                <form onSubmit={handleFaqSubmit} className="flex flex-col gap-4">
                  ...
                  <div className="w-48">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFaqForm({ ...faqForm, sort_order: Number(e.target.value) })
                      }
                      className="w-full bg-slate-700 text-white px-3 py-2 rounded-lg text-sm outline-none focus:ring-2 focus:ring-orange-500"
                    />
                  </div>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex gap-2 flex-shrink-0">
                        ...
                        {deleteFaqConfirm === item.id ? (
                          ...
                          <button
                            type="button"
                            onClick={() => setDeleteFaqConfirm(item.id)}
                            className="text-xs bg-slate-700 hover:bg-red-600 text-slate-400 hover:text-white px-3 py-1 rounded transition"
                          >
                            Hapus
                          </button>
              ...
              <div className="bg-slate-800 rounded-xl p-6 mb-8 border border-slate-700">
                ...
                >
                  <div>
                    ...
                    <select
                      required
                      value={desainForm.service_slug}
                      onChange={(e) =>
                        setDesainForm({ ...desainForm, service_slug: e.target.value })
                      }
                      className="w-full bg-slate-700 text-white px-3 py-2 rounded-lg text-sm outline-none focus:ring-2 focus:ring-orange-500"
                    >
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      value={desainForm.description}
                      onChange={(e) =>
                        setDesainForm({ ...desainForm, description: e.target.value })
                      }
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={desainForm.sort_order}
                      onChange={(e) =>
                        setDesainForm({ ...desainForm, sort_order: Number(e.target.value) })
                      }
                      className="w-full bg-slate-700 text-white px-3 py-2 rounded-lg text-sm outline-none focus:ring-2 focus:ring-orange-500"
                    />
                  </div>
                  ...
                  <tbody>
                    {desainItems.map((item: ServiceDesign) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <span className="bg-slate-700 text-slate-300 px-2 py-0.5 rounded text-xs">
                            {SERVICES_SLUGS.find((s) => s.slug === item.service_slug)?.label ??
                              item.service_slug}
                          </span>
                        </td>
                          ...
                          <div className="flex gap-2">
                            ...
                            {deleteDesainConfirm === item.id ? (
                              <div className="flex gap-1">
                                <button
                                  type="button"
                                  onClick={() => deleteDesainMutation.mutate(item.id)}
                                ...
                                <button
                                  type="button"
                                  onClick={() => setDeleteDesainConfirm(null)}
                                  className="text-xs bg-slate-700 hover:bg-slate-600 text-white px-2 py-1 rounded transition"
                                >
                                  ✕
                                </button>
                              ...
                              <button
                                type="button"
                                onClick={() => setDeleteDesainConfirm(item.id)}
                                className="text-xs bg-slate-700 hover:bg-red-600 text-slate-400 hover:text-white px-3 py-1 rounded transition"
                              >
                                Hapus
                              </button>
